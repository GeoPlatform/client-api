...
import { ItemService, DatasetService, ServiceService, LayerService, MapService, GalleryService, UtilsService, KGService, AgolService } from '@geoplatform/client';
...
export declare function kgServiceProviderFactory(http: HttpClient): KGService;
export declare function agolServiceProviderFactory(http: HttpClient): AgolService;
